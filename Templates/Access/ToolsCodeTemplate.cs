...
public class ToolsCodeTemplate:CodeTemplate
{
    public string GetCsharpType(ColumnSchema column)
	{
		...
		switch (column.DataType)
		{
			...
			case DbType.Date: type= "string";break;
			case DbType.DateTime: type= "string";break;
...
//		}
    ...
    {
        if((bool)column.ExtendedProperties["Autoincrement"].Value) 
		{
			return true;
		}
        else
    ...
    public string GetDynamicParams(TableSchema table)
    {
        string values=null;
        foreach(var column in table.Columns)
        {
    ...
    public string GetDynamicParamsNoPI(TableSchema table)
    {
        string values=null;
        foreach(var column in table.Columns)
        {
